...
class SelectCompanyPurchaseView
    extends GetView<SelectCompanyPurchaseController> {
  @override
    ...
    return DismissKeyboard(
        child: WillPopScope(
            ...
            child: Scaffold(
                ...
                body: GetBuilder<SelectCompanyPurchaseController>(
                    init: SelectCompanyPurchaseController(),
                    initState: (_) {},
                    builder: (_) {
