...
class DetialsStockProductView extends GetView<DetialsStockProductController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<DetialsStockProductController>(
            init: DetialsStockProductController(),
            initState: (_) {},
            builder: (_) {
                    ...
                    child: Column(
                      children: [
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            const SizedBox(width: 5),
                                            Text(
                                              "${"Please add your companys products to display your reports".tr}"
                                                  .tr,
                                              style: TextStyle(
                                                  fontSize: 10,
                                                  fontWeight: FontWeight.bold,
                        ...
                        Padding(
                          ...
                          child: MainButton(text: "Download".tr, press: () {}),
                        )
                      ],
                    ),
                  ),
