...
class SalesInvoiceHistoryView extends GetView<SalesInvoiceHistoryController> {
  @override
  final controller = Get.put(SalesInvoiceHistoryController());
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: BackButton(
                    ...
                    onPressed: () {
                      // Get.back();
                      Get.offAndToNamed(Routes.SELECT_COMPANY_SALES);
                    },
                  ),
                ),
                body: GetBuilder<SalesInvoiceHistoryController>(
                  init: SalesInvoiceHistoryController(),
                  initState: (_) {},
                  builder: (_) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //               controller.companyID==null;
                            //               controller.companyIDSearch =
                            //                   value.companyID;
                            //               controller.companyEName =
                            //                   value.companyEName;
                            //               print(controller.companyID);   print(controller.companyIDSearch);
                            //               controller.fetchInvoice(controller.companyIDSearch);
                            //                controller.update();
                            //             },
                            //           );
                            //         }).toList()
                            ...
                            // ),
                            controller.companyIDSearch == null
                                ? Container()
                                : Container(),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Align(
                                                                                ...
                                                                                child: Text("Please enter a date range to view invoices issued within the specified range".tr)),
                                                                            SizedBox(
                                                                            ...
                                                                            TextFormField(
                                                                              ...
                                                                              controller: controller.fromexpiryDateController,
                                                                              decoration: InputDecoration(
                                                                              ...
                                                                              onTap: () {
                                                                                showDatePicker(
                                                                                  ...
                                                                                  controller.fromexpiryDateController.text = DateFormat.yMMMd().format(value);
                                                                                });
                                                                              },
                                                                            ),
                                                                            SizedBox(
                                                                            ...
                                                                            TextFormField(
                                                                              autovalidateMode: AutovalidateMode.onUserInteraction,
                                                                              style: TextStyle(fontSize: 16),
                                                                              controller: controller.toexpiryDateController,
                                                                              decoration: InputDecoration(
                                                                                  hintText: "To Date".tr,
                                                                                  contentPadding: const EdgeInsets.all(12.0),
                                                                                  filled: true,
                                                                              ...
                                                                              onTap: () {
                                                                                showDatePicker(
                                                                                  ...
                                                                                  print(DateFormat.yMMMd().format(value!));
                                                                                  controller.toexpiryDateController.text = DateFormat.yMMMd().format(value);
                                                                                });
                                                                              },
                                                                            ),
                                                                            SizedBox(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      lang.appLocale ==
                                                                          ...
                                                                          : Text(controller.categoriesLis[index].companyAName.toString(), style: Theme.of(context).textTheme.headline5)
                                                                    ],
                                                                  ),
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      //         () {
                                                                      //  print(favorite);
                                                                      //      var LIST = favorite.indexWhere((element) =>
                                                                      //           element.data ==
                                                                      ...
                                                                      //    print(controller.categoriesLis[index]);
                                                                      //         favorite.add(controller.categoriesLis[index]);
                                                                      //         print("add");
            
                                                                      //       } else {
                                                                      //         favorite.removeAt(LIST);

                                                                      //         print('removeAt');
                                                                      //       }

                                                                      //       GetStorage().write("favoritSales",favorite);
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            Get.toNamed(Routes.SHOW_INVOICES, arguments: [
                                                                              controller.categoriesLis[index].companyID,
                                                                              lang.appLocale == 'en' ? controller.categoriesLis[index].companyEName.toString() : controller.categoriesLis[index].companyAName.toString(),
                                                                              ...
                                                                              //  lang.appLocale == 'en' ?  controller.InvoiceDetailsList[index].itemEName.toString():controller.InvoiceDetailsList[index].itemName.toString(),
                                                                            ...
                                                                            print('____________________invoiceDetails______________________');
                                                                            print(controller.categoriesLis[index].invoiceDetails.toString());
                                                                          },
                                                                          child:
                                                                              Center(
                                                                            child:
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      lang.appLocale ==
                                                                              'en'
                                                                          ? Text(
                                                                              sugg[index].companyEName.toString(),
                                                                              style: Theme.of(context).textTheme.headline5)
                                                                          : Text(sugg[index].companyAName.toString(), style: Theme.of(context).textTheme.headline5)
                                                                    ],
                                                                  ),
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            // print(controller.categoriesLis[index].invoiceDetails);
                                                                            Get.toNamed(Routes.SHOW_INVOICES, arguments: [
                                                                              sugg[index].companyID,
                                                                              lang.appLocale == 'en' ? sugg[index].companyEName.toString() : sugg[index].companyAName.toString(),
                                                                              sugg[index].address.toString(),
                                                                              sugg[index].taxNumber.toString(),
                                                                              sugg[index].activityLogo.toString(),
                                                                              sugg[index].invoiceID.toString(),
                                                                              sugg[index].totalAmount.toString(),
                                                                              sugg[index].totalIncludingTax.toString(),
                                                                              sugg[index].registerDate.toString(),
                                                                              sugg[index].registerTime.toString(),
                                                                              sugg[index].invoiceDetails,
                                                                              //  lang.appLocale == 'en' ?  controller.InvoiceDetailsList[index].itemEName.toString():controller.InvoiceDetailsList[index].itemName.toString(),
                                                                              // controller.InvoiceDetailsList[index].itemID.toString(),
                                                                              // controller.InvoiceDetailsList[index].count.toString(),
                                                                              // controller.InvoiceDetailsList[index].amount.toString(),
