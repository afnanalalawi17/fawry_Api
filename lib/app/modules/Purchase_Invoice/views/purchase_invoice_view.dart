...
class PurchaseInvoiceView extends GetView<PurchaseInvoiceController> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
        ...
        body: 
      GetBuilder<PurchaseInvoiceController>(
          init: PurchaseInvoiceController(),
          initState: (_) {},
          builder: (_) {
            return 
              ...
              child: Padding(
                ...
                child: Column(children: [
                  GestureDetector(
                    ...
                    onTap: () {
                       Get.toNamed(Routes.SELECT_COMPANY_PURCHASE);
                       },
                    child: Container(
                      margin: EdgeInsets.only(bottom: 20),
                      decoration: BoxDecoration(
