class Add_Favorite_Model {
  int? code;
  List<Data>? data;
  String? message;

  Add_Favorite_Model({this.code, this.data, this.message});

  Add_Favorite_Model.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  bool? isPaid;
  int? totalAmount;
  Null? discountTypeAName;
  Null? discountTypeEName;
  int? discountValue;
